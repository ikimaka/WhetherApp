...
import com.ikimaka.whetherapp.domain.usecase.GetCurrentWeatherUseCase
import com.ikimaka.whetherapp.domain.usecase.GetFavouriteCitiesUseCase
import com.ikimaka.whetherapp.presentation.favourite.FavouriteStore.Intent
import com.ikimaka.whetherapp.presentation.favourite.FavouriteStore.Label
import com.ikimaka.whetherapp.presentation.favourite.FavouriteStore.State
...
class FavouriteStoreFactory @Inject constructor(
    ...
    private sealed interface Msg {
        ...
        data class WeatherLoaded(val cityId: Int, val tempC: Float, val conditionIconUrl: String) :
            Msg
