...
import com.ikimaka.whetherapp.R
import com.ikimaka.whetherapp.domain.entity.Forecast
import com.ikimaka.whetherapp.domain.entity.Weather
import com.ikimaka.whetherapp.presentation.extensions.formattedFullDate
import com.ikimaka.whetherapp.presentation.extensions.formattedShortDayOfWeek
import com.ikimaka.whetherapp.presentation.extensions.tempToFormattedString
import com.ikimaka.whetherapp.presentation.ui.theme.CardGradients
...
private fun Forecast(forecast: Forecast) {
    Column(
        ...
        Spacer(modifier = Modifier.weight(1f))
        AnimateUpcomingWeather(upcoming = forecast.upcoming)
